...
void errorHandle(int argc, char *argv[], const char *msg);
...
int main(int argc, char *argv[])
{
	...
	{
		errorHandle(argc, argv, "SDL could not initialize!");
	}
	...
	if (!window)
	{
		errorHandle(argc, argv, "Window could not be created!");
	}
	...
	if (!screenSurface)
	{
		errorHandle(argc, argv, "Surface could not be created!");
	}

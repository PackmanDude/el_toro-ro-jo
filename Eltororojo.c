...
void errorHandle(char *argv[], const char *msg);
...
int main(int argc, char *argv[])
{
	...
	{
		errorHandle(argv, "SDL could not initialize!");
	}
	...
	if (!window)
	{
		errorHandle(argv, "Window could not be created!");
	}
	...
	if (!screenSurface)
	{
		errorHandle(argv, "Surface could not be created!");
	}
